    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Create Trading Item </h3>
                <div class="nk-block-des text-soft">
                    <p>Creating a new trading item for Commodity page.</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-lg-12 col-sm-6">
                                <div class="form-group">
                                    <label class="form-label" for="addTitle">Item Name</label>
                                    <input type="text" class="form-control" id="addTitle" placeholder="Item Name">
                                </div>
                            </div>
                            <div class="col-lg-12 col-sm-6">
                                <div class="form-group">
...
@push('scripts')
    <script>
        ...
        function resetImagemain() {
            document.getElementById("image_holder_main").classList.add('d-none');
            document.getElementById("cancel_image_button_main").classList.add('d-none');
            document.getElementById("image_button_main").classList.remove('d-none');
            document.getElementById("formFilemain").value = "";
        }

        function uploadImagemain() {
            document.getElementById("formFilemain").click();
        }

        function previewmain() {
            let oFReader = new FileReader();
            oFReader.readAsDataURL(document.getElementById("formFilemain").files[0]);

            oFReader.onload = function (oFREvent) {
                document.getElementById("image_button_main").classList.add('d-none');
                document.getElementById("image_holder_main").classList.remove('d-none');
                document.getElementById("image_holder_main").src = oFREvent.target.result;
                document.getElementById("cancel_image_button_main").classList.remove('d-none');
            };
        }
