...
@section('content')
    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Create Post Content</h3>
                <div class="nk-block-des text-soft">
                    <p>Creating a new Post Content for your webpage.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="postTags" placeholder="Enter tags">
...
@push('scripts')
    <script>
        ...
        $('#submitBtn').click(e => {
            ...
            formData.append('category', $('#main_menu_type').val());
            ...
            formData.append('tag', $('#postTags').val());
             // Get tags input value
