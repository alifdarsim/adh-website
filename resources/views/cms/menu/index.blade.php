        ...
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                ...
                <div class="nk-block-des text-soft">
                    <p>List of all Menu for the web pages</p>
                </div>
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li class="nk-block-tools-opt">
                                <a href="{{route('cms.menu.create')}}" class="btn btn-primary"><em class="icon ni ni-plus"></em>
                                    <span>Create New Sub Menu</span>
                                </a>
                            </li>
                        </ul>
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function edit(id) {
            window.location.href = '{{route('cms.menu.edit', ':id')}}'.replace(':id', id)
        }
        ...
        function remove(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{route('cms.menu.destroy',':id')}}".replace(':id', id),
                        type: 'DELETE',
                        dataType: "JSON",
                        data: {
                            "_token": "{{ csrf_token() }}",
