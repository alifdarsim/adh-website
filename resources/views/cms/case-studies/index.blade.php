    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title"> Case Studies Post List</h3>
                <div class="nk-block-des text-soft">
                    <p>List of all Case Studies Post for the web pages</p>
                </div>
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li class="nk-block-tools-opt">
                                <a href="{{route('cms.case-studies.create')}}" class="btn btn-primary"><em class="icon ni ni-plus"></em>
...
@push('scripts')
    ...
    <script>
        ...
        datatableInit('#datatable', {
            ajax: '{{route('cms.case-studies.index')}}',
            order:  [[4, 'desc']],
            columnDefs: [
        ...
        function featured(id) {
            $.ajax({
                url: "{{route('cms.case-studies.featured',':id')}}".replace(':id', id),
                type: 'GET',
                data: {
                    "_token": "{{ csrf_token() }}",
                },
        ...
        function edit(id) {
            window.location.href = '{{route('cms.case-studies.edit', ':id')}}'.replace(':id', id)
        }
        ...
        function remove(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{route('cms.case-studies.destroy',':id')}}".replace(':id', id),
                        type: 'DELETE',
                        dataType: "JSON",
                        data: {
                            "_token": "{{ csrf_token() }}",
