...
class ResourcesController extends Controller
{
    public function index()
    {
        ...
        ->get(['resources.*','pagetype.*','resources.id as resources_id']);
        return view('cms.resources.index', compact('pages'));
    }
    ...
    public function create()
    {
        ...
        return view('cms.resources.create', compact('menus','pagetype'));
    }
    ...
    return view('cms.resources.edit', compact('page', 'menus','submenus','pagetype'));
    }
