...
!function() {
    ...
    const f = Array.prototype.indexOf
        ...
        , O = e=>{
            const t = (e=>"ImageProxy HTTP error: " + x(k, (t=>e === t.code)).fold(p("Unknown ImageProxy error"), (e=>e.message)))(e);
        ...
        , S = (e,t)=>{
            ...
            return P(((e,t)=>{
                    ...
                    return e.ok ? Promise.resolve(e.blob) : ((e,t)=>"application/json" === (null == t ? void 0 : t.type) && (400 === e || 403 === e || 404 === e || 500 === e))(t = e.status, r = e.blob) ? (e=>(e=>new Promise(((t,r)=>{
        ...
        , M = (e,t)=>y.from((e=>{
                ...
                )(N(e), (t=>((e,t,r=!0)=>t ? S(e, t) : ((e,t)=>P(e, {}, t).then((e=>e.ok ? Promise.resolve(e.blob) : O(e.status))))(e, r))(((e,t)=>e + (-1 === e.indexOf("?") ? "?" : "&") + "url=" + encodeURIComponent(t))(r, t), o, !0).then(L, (t=>(e.notificationManager.open({
                    type: "error",
                    text: t
                }),
    ...
    const $ = e=>{
        ...
        , H = (e,t,r,o)=>{
            ...
            return e.setProgressState(!0),
                K(e, t, r).then((e=>o(e).then(e.download))).then(n, (t=>{
                        n(),
