...
const datatableInit = (datatable_element, object, tableInstance = null) => {
    ...
    $(function () {
        let dom = '<"row justify-between g-2"<"col-7 col-sm-4 text-start"><"col-5 col-sm-8 text-end"<"datatable-filter"<"d-flex justify-content-end g-2">>>><"datatable-wrap mb-3"t><"row align-items-center px-4 pb-3"<"col-7 col-sm-12 col-md-7"p><"col-5 col-sm-12 col-md-5 text-start text-md-end"i>>';
